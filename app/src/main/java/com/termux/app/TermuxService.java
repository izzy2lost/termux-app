...
import com.sm64builder.app.event.SystemEventReceiver;
import com.sm64builder.app.terminal.TermuxTerminalSessionActivityClient;
import com.sm64builder.app.terminal.TermuxTerminalSessionServiceClient;
...
import com.sm64builder.shared.termux.shell.TermuxShellUtils;
...
import com.sm64builder.shared.shell.command.ExecutionCommand.ShellCreateMode;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.sm64builder.shared.R.string.error_execution_cancelled))) {
